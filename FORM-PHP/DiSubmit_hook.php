...
try {
    ...
    if ($delivery_type === 'Toner') {
        ...
        $webhook_url = 'https://prod-31.westus.logic.azure.com:443/workflows/73b3fb1268f943fea9e42fc2cd4124f6/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=aHASlw4GMA0Mrg7KPvbfHbzWvP-vOiziActoS_ZWw-Y';
        $message = array(
            'title' => 'New Delivery Notification',
            'text' => json_encode(array(
                'Date Received' => $receive_date,
                'Tracking Number' => $tracking_number,
                'Delivery Company' => $delivery_company,
                'Type of Delivery' => $delivery_type,
                'Location' => $location,
                'Contents' => $shipment_contents,
                'Addressed To' => $addressed_to,
                'Contact Method' => $contact_method,
                'Person Contacted' => $individual_package_addressee,
                'Full Name' => $full_name
            ))
        );
