...
<html lang="en">
  ...
  <body>
    ...
    <div class="ticket-section" name="worm_was_here">
      <h2 style="margin: bottom 10px; "> Harborside Printer Checks </h2>

      <button class="switchButton" onclick="location.href='DCPrinterCheck.php'" id='campusSwitch'> Switch to Downcity </button>

      <div class="printer-container">

      <div id ="harborsidePrinters"></div>

    </div>
    <div class="copyright">
    <p> &copy; Johnson & Wales University 2025<span id="year"></span></p>
    </div>
  </body>
...
function checkCurrentDay(ip, title) {
    ...
    function createDiv(a, b, c) {
      ...
      document.getElementById("harborsidePrinters").append(section);
    }
